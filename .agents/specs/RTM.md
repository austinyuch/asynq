...
| R-10 | 「fix them」(open gaps:IL-001、IL-003、review 裁決機制) | SPEC-008 | `make proto` 重生、dash ANSI→PNG 實擷、`docs/assets/` disposition、首份 review.md | SPEC-008 review.md(全套測試綠 + live captures);ISSUE_LOG IL-R05/R06 |
