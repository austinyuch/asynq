...
| IL-R06(原 IL-003) | 2026-06-07 | visual 素材缺口(dash TUI 無擷取、`docs/assets/` 承襲 upstream) | SPEC-008:dash 文字+圖形層 fork 環境實擷(tmux -e → PNG);`docs/assets/` 逐檔 disposition(9 檔零引用 legacy、dash.gif=upstream 動畫示意);詳見 SPEC-008 review.md |
