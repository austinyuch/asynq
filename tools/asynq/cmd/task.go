...
func init() {
	...
	_ = taskListCmd.MarkFlagRequired("queue")
	_ = taskListCmd.MarkFlagRequired("state")
	...
	_ = taskInspectCmd.MarkFlagRequired("queue")
	_ = taskInspectCmd.MarkFlagRequired("id")
	...
	_ = taskArchiveCmd.MarkFlagRequired("queue")
	_ = taskArchiveCmd.MarkFlagRequired("id")
	...
	_ = taskDeleteCmd.MarkFlagRequired("queue")
	...
	_ = taskRunCmd.MarkFlagRequired("queue")
	...
	_ = taskEnqueueCmd.MarkFlagRequired("type_name")
	_ = taskEnqueueCmd.MarkFlagRequired("payload")
	...
	_ = taskArchiveAllCmd.MarkFlagRequired("queue")
	_ = taskArchiveAllCmd.MarkFlagRequired("state")
	...
	_ = taskDeleteAllCmd.MarkFlagRequired("queue")
	_ = taskDeleteAllCmd.MarkFlagRequired("state")
	...
	_ = taskRunAllCmd.MarkFlagRequired("queue")
	_ = taskRunAllCmd.MarkFlagRequired("state")
